...
public class CustomServiceApi {
     ...
     * @return ApiResult
     */
    public static ApiResult uploadKfAccountHeadImg(String kf_account, InputStream headImg,String fileName) {
        String accessToken = AccessTokenApi.getAccessTokenStr();
        String url = uploadKfAccountHeadImgUrl + accessToken + "&kf_account=" + kf_account;
        String jsonResult = HttpUtils.upload(url, headImg, fileName,null);
        return new ApiResult(jsonResult);
    }
    ...
    private static ApiResult sendMsg(String jsonStr) {
        String accessToken = AccessTokenApi.getAccessTokenStr();
        String jsonResult = HttpUtils.post(customMessageUrl + accessToken, jsonStr);
        return new ApiResult(jsonResult);
    }
