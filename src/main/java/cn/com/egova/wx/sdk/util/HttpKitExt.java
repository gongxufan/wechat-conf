...
class HttpKitExt {
     ...
     * @throws IOException
     */
    protected static String uploadMedia(String url, InputStream file,String fileName, String params) throws IOException {
        ...
        DataInputStream fs = new DataInputStream(file);
        int bytes = 0;
