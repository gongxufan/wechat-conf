 ...
 * 官方下载地址：http://commons.apache.org/proper/commons-codec/download_codec.cgi
 */
package cn.com.egova.wx.sdk.encrypt;

import cn.com.egova.wx.sdk.api.ApiConfigKit;
import cn.com.egova.wx.sdk.util.Base64Utils;
import cn.com.egova.wx.sdk.util.Charsets;
...
public class WXBizMsgCrypt {
    private final Logger logger = Logger.getLogger(WXBizMsgCrypt.class);
    private byte[] aesKey;
    ...
    public String encryptMsg(String replyMsg, String timeStamp, String nonce) throws AesException {
        ...
        if(ApiConfigKit.isDevMode()){
            logger.debug("发送给平台的签名是: " + signature.toString());
        }
        // 生成发送的xml
    ...
    public String decryptMsg(String msgSignature, String timeStamp, String nonce, String postData)
        ...
        // 和URL中的签名比较是否相等
        if(ApiConfigKit.isDevMode()){
            logger.debug("第三方收到URL中的签名：" + msgSignature);
            logger.debug("第三方校验签名：" + signature);
        }
