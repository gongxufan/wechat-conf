package cn.com.egova.wx.sdk.api.shakearound;

import cn.com.egova.wx.sdk.api.AccessTokenApi;
...
public class ShakeAroundMaterialApi {
     ...
     * @return ApiResult
     */
    public static ApiResult addMaterial(InputStream file, String fileName,MaterialType materialType) {
     ...
     * @return ApiResult
     */
    public static ApiResult addMaterial(InputStream file,String fileName) {
        return addMaterial(file,fileName, MaterialType.Icon);
    }
