...
public class MediaApi {
     ...
     * @return ApiResult
     */
    public static ApiResult uploadMedia(MediaType mediaType, InputStream file,String fileName) {
        String url = upload_url + AccessTokenApi.getAccessTokenStr() + "&type=" + mediaType.get();
        String jsonStr = HttpUtils.upload(url, file, fileName,null);
     ...
     * @return ApiResult
     */
    public static ApiResult uploadImg(InputStream imgFile,String fileName) {
        String url = uploadImgUrl + AccessTokenApi.getAccessTokenStr();

        String jsonResult = HttpUtils.upload(url, imgFile,fileName, null);
        return new ApiResult(jsonResult);
    }
     ...
     * @return ApiResult
     */
    public static ApiResult addMaterial(String type,InputStream file,String fileName) {
        String url = addMaterialUrl + AccessTokenApi.getAccessTokenStr()+ "&type=" + type;

        String jsonResult = HttpUtils.upload(url, file,fileName, null);
        return new ApiResult(jsonResult);
    }
     ...
     * @return ApiResult
     */
    public static ApiResult addMaterial(String type,InputStream file,String fileName, String title, String introduction) {
        String url = addMaterialUrl + AccessTokenApi.getAccessTokenStr() + "&type=" + type;
        ...
        String jsonResult = HttpUtils.upload(url, file,fileName, JsonUtils.toJson(dataMap));
        return new ApiResult(jsonResult);
    }
